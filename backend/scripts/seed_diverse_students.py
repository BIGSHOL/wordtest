...
# ── 5티어 학생 프로필: 6축 정답률 범위 ──
PROFILES = {
    "최상": {
        "meaning": (0.88, 0.98), "association": (0.85, 0.95),
        "listening": (0.85, 0.95), "inference": (0.82, 0.92),
        "spelling": (0.80, 0.92), "comprehensive": (0.78, 0.90),
        "time": (2.0, 5.0), "sessions": (10, 10),
    },
    "상": {
        "meaning": (0.75, 0.88), "association": (0.72, 0.85),
        "listening": (0.72, 0.85), "inference": (0.68, 0.82),
        "spelling": (0.65, 0.80), "comprehensive": (0.62, 0.78),
        "time": (3.0, 7.0), "sessions": (10, 10),
    },
    "중": {
        "meaning": (0.55, 0.72), "association": (0.52, 0.70),
        "listening": (0.52, 0.70), "inference": (0.48, 0.65),
        "spelling": (0.45, 0.62), "comprehensive": (0.42, 0.60),
        "time": (4.0, 10.0), "sessions": (10, 10),
    },
    "하": {
        "meaning": (0.32, 0.52), "association": (0.28, 0.48),
        "listening": (0.28, 0.48), "inference": (0.25, 0.45),
        "spelling": (0.22, 0.42), "comprehensive": (0.20, 0.38),
        "time": (5.0, 14.0), "sessions": (10, 10),
    },
    "최하": {
        "meaning": (0.12, 0.28), "association": (0.10, 0.25),
        "listening": (0.10, 0.25), "inference": (0.08, 0.22),
        "spelling": (0.08, 0.20), "comprehensive": (0.05, 0.18),
        "time": (6.0, 18.0), "sessions": (10, 10),
    },
}

# ── 학년별 학생 구성: 10명/학년 (티어별 2명) × 10세션 = 100세션/학년 ──
GRADE_STUDENTS = {
    "초6": [
        ("김초롱", "최상"), ("이하늘", "최상"),
        ("박소라", "상"), ("최다은", "상"),
