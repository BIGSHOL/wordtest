...
| `backend/app/api/v1/level_test.py` | 레벨테스트 API 라우터 |
| `backend/app/api/v1/grammar.py` | 문법 테스트 API 라우터 |
...
| `backend/app/services/level_test.py` | 레벨테스트 서비스 |
| `backend/app/services/grammar_service.py` | 문법 테스트 서비스 |
...
| `backend/app/schemas/level_test.py` | 레벨테스트 스키마 |
| `backend/app/schemas/grammar.py` | 문법 테스트 스키마 |
...
| `backend/app/models/grammar_answer.py` | GrammarAnswer 모델 |
| `backend/app/models/grammar_book.py` | GrammarBook 모델 |
| `backend/app/models/grammar_chapter.py` | GrammarChapter 모델 |
| `backend/app/models/grammar_config.py` | GrammarConfig 모델 |
| `backend/app/models/grammar_point.py` | GrammarPoint 모델 |
| `backend/app/models/grammar_question.py` | GrammarQuestion 모델 |
| `backend/app/models/grammar_sentence.py` | GrammarSentence 모델 |
| `backend/app/models/grammar_session.py` | GrammarSession 모델 |
...
Grep pattern="\b(levelup_service|legacy_service|test_common|auth|student|test_assignment|test_config|report_engine|grammar_service|level_test)\.\w+\(" path="backend/app/api/v1/" output_mode="content"
```
