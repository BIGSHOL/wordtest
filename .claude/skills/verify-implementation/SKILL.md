...
| # | 스킬 | 설명 |
|---|------|------|
| 1 | `verify-question-pipeline` | 문제 생성 파이프라인 외래어 필터링/중복 제거 일관성 검증 |
| 2 | `verify-api-consistency` | 백엔드 Router-Service-Schema-Model 계층 간 참조 일관성 검증 |
| 3 | `verify-frontend-routes` | 프론트엔드 Route-Page-Nav-Store-Service 간 참조 일관성 검증 |
