...
| `frontend/src/pages/teacher/LevelTestPage.tsx` | 레벨테스트 페이지 |
...
| `frontend/src/pages/student/GrammarTestPage.tsx` | 문법 테스트 페이지 |
...
| `frontend/src/services/levelTest.ts` | 레벨테스트 API 서비스 |
| `frontend/src/services/grammarTest.ts` | 문법 테스트 API 서비스 |
| `frontend/src/stores/grammarTestStore.ts` | 문법 테스트 스토어 |
| `frontend/src/types/test.ts` | 레거시 테스트 결과 조회용 타입 (TestSessionData, AnswerDetail) |
| `frontend/src/types/grammar.ts` | 문법 테스트 타입 정의 |
